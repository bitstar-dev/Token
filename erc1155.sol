...
contract BTSNFT is ERC1155, Ownable {
    
    string public _symbol = 'BTS';
    string public _symbolNFT = 'BTSNFT';
    
    uint256 public _currentTokenID = 0;
    uint256 public constant BTS = 0;
    
    constructor() ERC1155("http://ipfsinfo.bitstar.store:8081/json/ipfs/{id}") {
        _mint(msg.sender, BTS, 18000000, "");
    }
    ...
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data)
        ...
        onlyOwner
    {
        _currentTokenID = _currentTokenID + ids.length;
